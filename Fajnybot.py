...
async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='Paradise RP'))
        await asyncio.sleep(2)
        await client.change_presence(game=discord.Game(name='Najlepszy serwer RolePlay'))
        await asyncio.sleep(2)
